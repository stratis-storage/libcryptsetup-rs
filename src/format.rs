...
impl<'a> CryptParams for CryptParamsLuks1Ref<'a> {
    fn as_ptr(&mut self) -> *mut c_void {
        (&mut self.inner as *mut libcryptsetup_rs_sys::crypt_params_luks1).cast::<libc::c_void>()
    }
}
...
impl<'a> CryptParams for CryptParamsLuks2Ref<'a> {
    fn as_ptr(&mut self) -> *mut c_void {
        (&mut self.inner as *mut libcryptsetup_rs_sys::crypt_params_luks2).cast::<libc::c_void>()
    }
}
...
impl<'a> CryptParams for CryptParamsVerityRef<'a> {
    fn as_ptr(&mut self) -> *mut c_void {
        (&mut self.inner as *mut libcryptsetup_rs_sys::crypt_params_verity).cast::<libc::c_void>()
    }
}
...
impl<'a> CryptParams for CryptParamsLoopaesRef<'a> {
    fn as_ptr(&mut self) -> *mut c_void {
        (&mut self.inner as *mut libcryptsetup_rs_sys::crypt_params_loopaes).cast::<libc::c_void>()
    }
}
...
impl<'a> CryptParams for CryptParamsIntegrityRef<'a> {
    fn as_ptr(&mut self) -> *mut c_void {
        (&mut self.inner as *mut libcryptsetup_rs_sys::crypt_params_integrity)
            .cast::<libc::c_void>()
    }
}
...
impl<'a> CryptParams for CryptParamsPlainRef<'a> {
    fn as_ptr(&mut self) -> *mut c_void {
        (&mut self.inner as *mut libcryptsetup_rs_sys::crypt_params_plain).cast::<libc::c_void>()
    }
}
        ...
        Ok(CryptParamsTcryptRef {
            inner: libcryptsetup_rs_sys::crypt_params_tcrypt {
                passphrase: match self.passphrase {
                    Some(ref pass) => pass.as_ptr().cast::<i8>(),
                    None => std::ptr::null(),
                },
...
impl<'a> CryptParams for CryptParamsTcryptRef<'a> {
    fn as_ptr(&mut self) -> *mut c_void {
        (&mut self.inner as *mut libcryptsetup_rs_sys::crypt_params_tcrypt).cast::<libc::c_void>()
    }
}
